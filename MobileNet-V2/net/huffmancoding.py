            ...
            if weight.ndim == 4:
                ...
                for i in range(weight.shape[0]):
                    for j in range(weight.shape[1]):
                        ...
                        # Encode
                        t01, d01 = huffman_encode(mat.data, name+f'_{form}_data', directory)
                        compressed += t01
                        compressed += d01
                        t12, d12 = huffman_encode(mat.indices, name+f'_{form}_indices', directory)
                        compressed += t12
                        compressed += d12
                        t23, d23 = huffman_encode(calc_index_diff(mat.indptr), name+f'_{form}_indptr', directory)
                        compressed += t23
                        compressed += d23
                        originals = mat.data.nbytes + mat.indices.nbytes + mat.indptr.nbytes
                        original += originals
            # Print statistics
            #original =
